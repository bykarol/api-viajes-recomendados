...
const { postUser, loginUser, modifyPassword, updateUser, validateUser } = require('../controllers/users');
...
router.patch('/users/update/:id', validateParams, validateBody, isUser, updateUser);
